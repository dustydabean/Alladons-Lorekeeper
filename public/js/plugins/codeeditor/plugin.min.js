...
function showtinymce() {
    saveContent();
    document.querySelector(".tox").classList.remove("hide");
    document.querySelector("#ace-code-editor-wrapper").classList.add("hide");
}
...
!(function () {
    ...
    (c.src =
        ...
        (tryToBuildAceTimer = setInterval(() => {
            try {
                document.querySelector(".tox").insertAdjacentHTML(
                    "afterend",
                    `<div id="ace-code-editor-wrapper" class="hide" style="border: 1px solid lightgrey; border-radius: 2px; height: fit-content;">
                    <button onclick="showtinymce()" type="button" class="btn btn-sm editor-btn py-0 px-1 m-1" data-toggle="tooltip" title="switch back to wysiwig editor"><i class="fas fa-paragraph"></i></button>
                    <div id="ace-code-editor" style="height: 300px; resize:vertical;"></div>
                </div>`
                );
                (aceEditor = ace.edit("ace-code-editor")).setTheme(
                    "ace/theme/chrome"
                ),
                ...
                let child = document.querySelector("#ace-code-editor-wrapper");
        ...
        tinymce.PluginManager.add("codeeditor", function (e) {
            return (
                e.ui.registry.addButton("codeeditor", {
                    ...
                    tooltip: "Code Editor",
                    onAction: function () {
                        document.querySelector(".tox").classList.add("hide");
                        document
