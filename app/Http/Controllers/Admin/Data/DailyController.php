...
class DailyController extends Controller
{
    ...
    */
    ...
    public function postCreateEditDaily(Request $request, DailyService $service, $id = null)
    {
        ...
        $data = $request->only([
            'name', 'description', 'image', 'button_image' ,'remove_image','remove_button_image', 'has_image', 'has_button_image','rewardable_type', 'rewardable_id', 'quantity', 'is_active', 'is_one_off', 'is_timed_daily', 'start_at', 'end_at', 'max_roll', 'item_id', 'currency_id',
        ]);
