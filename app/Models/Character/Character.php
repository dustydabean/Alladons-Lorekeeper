...
class Character extends Model {
    ...
    public static $createRules = [
        ...
        'sale_value'            => 'nullable',
        'image'                 => 'required|mimes:jpeg,jpg,gif,png|max:6000',
        'thumbnail'             => 'nullable|mimes:jpeg,jpg,gif,png|max:6000',
    ...
    public static $updateRules = [
        ...
        'sale_value'            => 'nullable',
        'poucher_code'          => 'nullable|between:1,20',
        'image'                 => 'nullable|mimes:jpeg,jpg,gif,png|max:6000',
        'thumbnail'             => 'nullable|mimes:jpeg,jpg,gif,png|max:6000',
    ];
    ...
    public static $myoRules = [
        ...
        'sale_value'  => 'nullable',
        'name'        => 'required',
        'image'       => 'nullable|mimes:jpeg,gif,png|max:6000',
        'thumbnail'   => 'nullable|mimes:jpeg,gif,png|max:6000',
    ];
