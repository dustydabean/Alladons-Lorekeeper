    ...
    **********************************************************************************************/
    ...
    public function deletePet($pet)
    {
        ...
        try {
            ...
            if(DB::table('user_pets')->where('pet_id', $pet->id)->where('count', '>', 0)->exists()) throw new \Exception("At least one user currently owns this pet. Please remove the pet(s) before deleting it.");
