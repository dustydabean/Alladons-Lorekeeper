...
class SpeciesService extends Service
{
    ...
    */
     ...
     * @param  array                  $data 
     * @param  \App\Models\User\User  $user
     * @return bool|\App\Models\Species\Transformation
     */
    public function createTransformation($data, $user)
    {
        ...
        try {
            ...
            if ($image) $this->handleImage($image, $transformation->transformationImagePath, $transformation->transformationImageFileName);
     ...
     *
     * @param  \App\Models\Species\Transformation  $transformation
     * @param  array                        $data 
     * @param  \App\Models\User\User        $user
     * @return bool|\App\Models\Species\Transformation
     */
    public function updateTransformation($transformation, $data, $user)
    {
        ...
        try {
            ...
            if ($transformation) $this->handleImage($image, $transformation->transformationImagePath, $transformation->transformationImageFileName);
    ...
    public function deleteTransformation($transformation)
    {
        ...
        try {
            ...
            if(CharacterImage::where('transformation_id', $transformation->id)->exists()) throw new \Exception("A character image with this transformation exists. Please change or remove its transformation first.");
            
            if($transformation->has_image) $this->deleteImage($transformation->transformationImagePath, $transformation->transformationImageFileName); 
