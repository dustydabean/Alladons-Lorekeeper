...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Transformations' => 'admin/data/transformations', ($transformation->id ? 'Edit' : 'Create').' Transformation' => $transformation->id ? 'admin/data/transformations/edit/'.$transformation->id : 'admin/data/transformations/create']) !!}
