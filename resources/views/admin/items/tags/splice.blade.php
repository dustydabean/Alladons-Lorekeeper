...
<p>If you want this splice item to only apply specific variants from each companion, select them here. Otherwise, leave this blank to be able to apply any variant.</p>
