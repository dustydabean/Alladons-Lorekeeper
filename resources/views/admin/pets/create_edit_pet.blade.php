...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            {!! Form::label('is_visible', 'Is Visible', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If this is turned off, the companion will not be visible on world pages.') !!}
        </div>
        <div class="col-md-6 form-group">
    ...
    @if ($pet->id)
        ...
        @if (!$pet->isVariant)
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p>
                        Variants are different colourations, patterns, or other visual differences that a companion can have.
                        <br />They are technically separate companions, but are treated as variants of the same companion.
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <p>
                    If you would like your companion to "evolve" (similarly to Pokémon), you can set up evolutions here. Evolutions are not required, and you can have as many or as few as you like. If you do not set up any evolutions, the companion will not evolve.
                </p>
                <p>
                    Please note that variants will not be carried over to the evolved companion. If you would like to have a variant evolve into another variant, you will need to set up an evolution for each variant (after an evolution has been created).
                </p>
