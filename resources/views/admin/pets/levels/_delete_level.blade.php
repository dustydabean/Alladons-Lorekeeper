@if ($level)
    ...
    <p>You are about to delete the level <strong>{{ $level->name }}</strong>. This is not reversible. If this level is currently reached by any companion you will be unable to delete it.</p>
