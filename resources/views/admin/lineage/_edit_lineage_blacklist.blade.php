...
<div class="form-check mb-1">
    <label class="form-check-label">
        ...
        Characters with this {{ $type }} can have ancestors but not descendants. This will stop affected characters from participating in pairings.
...
<div class="form-check disabled mb-2">
    <label class="form-check-label">
        ...
        Characters with this {{ $type }} cannot have lineages at all. This will stop affected characters from participating in pairings.
