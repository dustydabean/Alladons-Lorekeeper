    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @include('home.trades.listings._seeking_summary', ['user' => $listing->user, 'data' => isset($listing->data['seeking']) ? parseAssetData($listing->data['seeking']) : null, 'listing' => $listing])
            </div>
            <div class="col-md-6">
                <h3 class="card-heading">
                    Offering:
                </h3>
                @include('home.trades.listings._offer_summary', ['user' => $listing->user, 'data' => isset($listing->data['offering']) ? parseAssetData($listing->data['offering']) : null, 'listing' => $listing])
            </div>
        </div>
        <hr />
