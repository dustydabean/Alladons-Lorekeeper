<li class="list-group-item">
    ...
    <div id="breedingPermForm" class="collapse">
        ...
        <p>This will grant the selected character {{ $tag->data }} breeding permission{{ $tag->data == 1 ? '' : 's' }}. This action is not reversible. Are you sure you want to redeem {{ $tag->data == 1 ? 'this' : 'these' }} breeding permission{{ $tag->data == 1 ? '' : 's' }}?</p>
