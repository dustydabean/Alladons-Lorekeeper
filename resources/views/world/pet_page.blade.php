...
@section('content')
    ...
    <x-admin-edit title="Companion" :object="$pet" />
                            ...
                            @if ($pet->hasDrops)
                                <div class="card">
                                    <h5 class="card-header inventory-header">
                                        <a class="inventory-collapse-toggle collapse-toggle collapsed" href="#drop-collapse" data-toggle="collapse">Show Drops</a>
                                    </h5>
