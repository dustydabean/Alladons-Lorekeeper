<div class="row world-entry">
    @if($transformation->transformationImageUrl)
        <div class="col-md-3 world-entry-image"><a href="{{ $transformation->transformationImageUrl }}" data-lightbox="entry" data-title="{{ $transformation->name }}"><img src="{{ $transformation->transformationImageUrl }}" class="world-entry-image" alt="{{ $transformation->name }}" /></a></div>
    @endif
